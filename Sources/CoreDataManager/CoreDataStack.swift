...
protocol CoreDataStackProtocol {
    static var applicationDocumentsDirectory: URL { get }
    static var managedObjectModel: NSManagedObjectModel { get }
    static var persistentStoreCoordinator: NSPersistentStoreCoordinator { get }
...
open class CoreDataStack: CoreDataStackProtocol {
    ...
    public static var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle(for: CoreDataStack.self).url(forResource: "mainCore", withExtension: "momd")! // type your database name here..
